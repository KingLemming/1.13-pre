...
public class BehaviorMorbDispense extends BehaviorDefaultDispenseItem {
	...
	public BehaviorMorbDispense(boolean reusable) {
	...
	protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
		...
		EntityMorb morb = new EntityMorb(world, pos.getX(), pos.getY(), pos.getZ(), reusable, stack.hasTagCompound() ? stack.getTagCompound() : new NBTTagCompound());
