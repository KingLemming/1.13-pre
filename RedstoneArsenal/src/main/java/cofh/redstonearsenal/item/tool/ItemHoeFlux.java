...
import cofh.core.item.tool.ItemHoeCoFH;
...
public class ItemHoeFlux extends ItemHoeCoFH implements IEnergyContainerItem, IMultiModeItem {
	...
	public ItemHoeFlux(ToolMaterial toolMaterial) {
	...
	public ItemHoeFlux setEnergyParams(int maxEnergy, int maxTransfer, int energyPerUse, int energyPerUseEmpowered) {
