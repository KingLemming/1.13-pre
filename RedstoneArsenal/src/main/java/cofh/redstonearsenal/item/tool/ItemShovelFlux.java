...
import static cofh.lib.util.helpers.StringHelper.isShiftKeyDown;

public class ItemShovelFlux extends ItemToolFlux implements IAreaEffectItem {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(getNoticeText("info.redstonearsenal.tool.shovel"));
	}
