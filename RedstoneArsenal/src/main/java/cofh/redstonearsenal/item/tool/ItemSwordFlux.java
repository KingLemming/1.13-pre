...
import cofh.core.item.tool.ItemSwordCoFH;
...
public class ItemSwordFlux extends ItemSwordCoFH implements IEnergyContainerItem, IMultiModeItem {
	...
	protected int damageEmpowered = 10;
	...
	public ItemSwordFlux setEnergyParams(int maxEnergy, int maxTransfer, int energyPerUse, int energyPerUseEmpowered) {
