...
public class MachinesTE {
	...
	public static final AbstractTileType SMELTER = registerMachine("smelter", 15, TileMachineSmelter.class, ContainerMachineSmelter.class, GuiMachineSmelter.class);

	public static final AbstractTileType CRUCIBLE = registerMachine("crucible", 15, TileMachineCrucible.class, ContainerMachineCrucible.class, GuiMachineCrucible.class);
	...
	// public static final TileStruct BREWER = registerMachine("brewer", 12, TileMachineBrewer.class, ContainerMachineBrewer.class, GuiMachineBrewer.class);
