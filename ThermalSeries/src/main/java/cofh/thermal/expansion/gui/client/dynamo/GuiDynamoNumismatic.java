...
import cofh.thermal.expansion.gui.container.dynamo.ContainerDynamoNumismatic;
...
public class GuiDynamoNumismatic extends GuiDynamo {

	public static final String TEX_PATH = ID_THERMAL_SERIES + ":textures/gui/dynamo/numismatic.png";
	public static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);

	public GuiDynamoNumismatic(InventoryPlayer inventory, TileEntity tile) {

		super(new ContainerDynamoNumismatic(inventory, tile), (TileDynamo) tile, inventory.player, generateTabInfo("tab.thermal.dynamo_numismatic"));
		name = StringHelper.localize("tile.thermal.dynamo_numismatic.name");
		texture = TEXTURE;
	}
